...
If you encounter an accessibility issue, or you have a suggestion to improve Garden Fleet for users with disabilities, please get in touch via the contact details in [IMPRESSUM.md](../legal/IMPRESSUM.md). We treat accessibility reports as priority.
...
Wenn du auf ein Accessibility-Problem stößt oder einen Vorschlag zur Verbesserung hast, melde dich bitte über die Kontaktdaten in [IMPRESSUM.md](../legal/IMPRESSUM.md). Wir behandeln solche Meldungen mit hoher Priorität.
